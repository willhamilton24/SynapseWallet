...
struct CustomColors {
    ...
    let light2 = Color(UIColor(red:0.97, green:0.97, blue:0.97, alpha:1.0))
    
    let prime2 = Color(UIColor(red:0.00, green:1.00, blue:0.78, alpha:1.0))
    
    let primeGradiant = LinearGradient(gradient: Gradient(colors: [Color(UIColor(red:0.00, green:0.28, blue:1.00, alpha:1.0)), Color(UIColor(red:0.00, green:1.00, blue:0.78, alpha:1.0))]), startPoint: UnitPoint(x: 1, y: 1), endPoint: UnitPoint(x: 0, y: 0))
